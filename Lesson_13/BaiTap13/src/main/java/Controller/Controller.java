...
public class Controller {
    ...
    public void countBookByType(){
        Map<String, Integer> countType = service.sortByType();
        for (Map.Entry<String, Integer> entry : countType.entrySet()) {
            System.out.println("Thể loại: " + entry.getKey() + " - " + "Số lượng sách: "+ entry.getValue());
        }
    }
    ...
    public static void menu() {
        ...
        System.out.println("1 - Xem toàn bộ thư viện sách");
